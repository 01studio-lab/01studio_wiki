...
## 实验平台
pyWiFi-ESP32-S3开发套件和土壤湿度传感器模块。

![iamge](./img/soil_wet/kit.jpg) 
...
土壤湿度传感器接在传感器接口1，对应pyBase的引脚是“Y11”，也就是pyWiFi-ESP32-S3的‘10’引脚，ADC使用内部11DB衰减器，将量程增至0-3.3V，使用13bit精度，即最大值为2^12-1=4095。然后我们根据实际测试数据将检测到的数值0-4095分成三段，分别代表土壤干燥：【0-1247】，中等：【1247-2238】，湿润：【2238-4095】。当然开发者可以根据自己实际情况来调整数值。编程流程图如下：
