...
pyWiFi-ESP32-S3开发套件和RGB灯带。[**点击购买>>**](https://item.taobao.com/item.htm?id=624485087977)

![servo](./img/neopixel/kit.png)
...
本实验使用pyBase传感器接口'Y11'引脚控制灯带，对应ESP32-S3的引脚10，供电使用3.3。**（市面上大部分灯珠能5V供电然后使用3.3V电平的IO控制）**
...
01Studio pyWiFi ESP32-S3的MicroPython固件集成了彩灯驱动模块（NeoPixel），适用于WS2812B驱动的灯珠。因此我们可以直接使用。对象说明如下：
