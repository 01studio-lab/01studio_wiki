...
该软件可以在 **开发板配套资料包\01-开发工具\MicroPython开发软件(Thonny IDE)\Thonny** 目录下获取。默认提供Windows的安装包。

![thonny_ide](./img/thonny_ide/thonny_ide0.png)


当然你也可以在在 https://thonny.org/ 下载最新版，选择自己的开发平台进行下载安装即可(这里选择Windows！)：

![thonny_ide](./img/thonny_ide/thonny_ide1.png)

打开后根据提示安装即可，安装完成后如果在桌面没用找到该软件，可以在安装路径或者在系统搜索栏搜索 thonny关键词找到该软件。打开软件，如下图所示，至此安装完成。

![thonny_ide](./img/thonny_ide/thonny_ide2.png)
