...
![intro2](./img/product/intro1.png)

### 引脚图

![intro](./img/product/intro2.png)
...
| FLASH  | 1M Bytes | 
| SD卡槽  | 最大支持64GB | 
| LED  |  ● 可编程LED1（红色）<br></br> ● 可编程LED2（绿色）<br></br> ● 可编程LED3（黄色）<br></br> ● 可编程LED4（蓝色） |
| 按键  |  ● 可编程按键（USR）<br></br> ● 复位键 (RST) |
...
![intro](./img/product/pybase2.png)

### 组合使用图

![intro](./img/product/pybase3.png)

![intro](./img/product/pybase4.png)
