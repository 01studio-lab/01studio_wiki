...
除了之前学习的4.3寸大屏，今天我们来学习一下小的OLED显示屏。本节的OLED显示屏学习，实际上是在使用I2C的总线接口，麦哲伦主控是通过I2C总线与OLED显示屏通讯的。学完本节，你就多了一个显示屏选择了。

## 实验平台

麦哲伦开发板 + 0.96寸OLED。

![timer](./img/oled/oled1.jpg)
...
从上图可知，开发板的PB0引脚连接到SCL，PI3引脚连接到SDA，本节使用会用到Pin、SoftI2C和ssd1306对象，介绍如下：
...
i2c = SoftI2C(sda=Pin("I3"), scl=Pin("B0")) #I2C初始化：sda--> I3, scl --> B0
