...
## 前言
本节讲解麦哲伦 + 4.3寸RGB屏的电容触摸屏使用方法。

## 实验平台
麦哲伦MicroPython开发套件、4.3寸RGB显示屏（电容触摸）。

![touch](./img/4_3_rgb_t/4_3_rgb_t1.png)
...
本节实现当手指按下时候，通过简单的编程即可返回一个坐标，4.3寸RGB屏上的电容触摸驱动芯片是FT5436，我们来看看其micropython构造函数和使用方法：
...
更多用法请阅读官方文档：<br></br>
https://docs.01studio.cc/library/touch/touch.FT5436.html
<br></br>
...
![touch](./img/4_3_rgb_t/4_3_rgb_t3.jpg)

按下USR按键清空屏幕内容：

![touch](./img/4_3_rgb_t/4_3_rgb_t4.jpg)
