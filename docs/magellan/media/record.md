...
## 前言
上一节我们学习了音频文件播放，而麦哲伦上的音频驱动芯片还支持录音功能，且开发板已经集成了麦克风和线性输入接口，也就是说我们可以通过麦克风录音或标准3.5MM耳机线将音频信号传输给开发板录制。

## 实验平台
麦哲伦开发套件。
![img](./img/record/kit.png)
...
KEY_E = Pin('A15',Pin.IN,Pin.PULL_UP) #构建按键A15
