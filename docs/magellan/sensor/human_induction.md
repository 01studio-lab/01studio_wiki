...
![human_induction1](./img/human_induction/human_induction0.jpg) 
...
由此可见，可以使用外部中断结合上升沿的出发方式来编程实现相关功能。传感器的输出引脚连接Sensor1接口，即连接到麦哲伦的“B1”引脚。编程方法可以是当“B1”引脚产生中断时候，说明传感器检测到人体红外线，此时可以在OLED上显示相关信息。
...
![human_induction5](./img/human_induction/human_induction3.jpg) 
