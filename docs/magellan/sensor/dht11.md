...
可以看到DHT11连接到麦哲伦主控的‘PB4’引脚，可以针对该引脚编程来驱动DHT11传感器，函数模块说明如下：
...
运行代码，可以看到LCD显示采集到的温湿度信息：

![dht11](./img/dht11/dht11_4.jpg)
