...
## 前言
相信大部分人开始学习嵌入式单片机编程都会从点亮LED开始，基于MicroPython的pyDrone平台学习也不例外，通过点亮第一个LED能让你对编译环境和程序架构有一定的认识，为以后的学习和更大型的程序打下基础，增加信心。
...
pyDrone上有1个LED（蓝色），跟主控ESP32-S3模块引脚46相连，通过输出高电平方式点亮。
