...
将`yolo11n_cls_320.kmodel` 和`val.jpg`拖动到CanMV K230 `sdcart`根目录：
...
代码中的`display`参数可以实现不同的显示方式：`hdmi`、`lcd3_5`(3.5寸mipi屏)和`lcd2_4`(2.4寸mipi屏，通常是CanMV K230 mini)
